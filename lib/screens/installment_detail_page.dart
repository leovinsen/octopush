...
class InstallmentDetailPage extends StatelessWidget {
  ...
  InstallmentDetailPage(this.installmentType, this.label) : repository = InstallmentRepository();
  ...
  Widget _buildBody(BuildContext context) {
    List<InstallmentOption> options = repository.getOptions(this.installmentType);
    var basePrice = CurrencyUtils.formatToIdr(basePrices[installmentType.index].toDouble());
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text('Base price: $basePrice ', style: subtitleStyle, ),
          ...
          ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              var pricePerInterval = CurrencyUtils.formatToIdr(option.intervalInstallment);
